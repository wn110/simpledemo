...
Ext.define('Ext.ux.grid.feature.Searching', {
    ...
    , onTriggerSearch: function () {
        ...
        if ('local' === this.mode) {
            ...
            delete (proxy.extraParams["fields"]);
            delete (proxy.extraParams["query"]);
            if (store.lastOptions && store.lastOptions.params) {
                //delete (proxy.lastOptions.params["fields"]);
                //delete (proxy.lastOptions.params["query"]);
            }
            if (fields.length) {
                proxy.extraParams["fields"] = (fields);
                proxy.extraParams["query"] = (val);
            }
